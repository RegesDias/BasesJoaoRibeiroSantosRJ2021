    ...
    <div class="container">
        ...
        <form method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nome" class="form-control" id="Nome" aria-describedby="nameHelp" placeholder="Digite novo nome de Usuário">
            ...
            <div class="form-group">
                ...
                <input type="password" name="senha" class="form-control" id="Password" placeholder="Insira nova senha">
            </div>
